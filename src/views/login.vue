<template>
    <section class="relative min-h-[calc(100vh-64px)] bg-cover bg-center transition-colors duration-300"
        ...
        <div class="absolute top-4 right-4 z-20">
            <button @click="toggleTheme"
                class="p-2 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-300 shadow-md"
        ...
        <div class="relative z-10 flex items-center justify-center min-h-[calc(100vh-64px)] py-12 px-4">
            ...
            <div class="w-full max-w-md">
                <div class="bg-white dark:bg-dark-surface rounded-lg shadow-lg p-8 transition-colors duration-300">
                    <h1 class="text-3xl font-bold text-center text-gray-900 dark:text-white mb-8 font-audiowide">Iniciar
                        Sesión</h1>

                    <div v-if="errorMessage"
                        class="mb-4 p-4 bg-red-100 dark:bg-red-900 border border-red-400 dark:border-red-700 text-red-700 dark:text-red-200 rounded-lg flex items-start justify-between">
                    ...
                    <form @submit.prevent="handleLogin" class="space-y-4">
                        <div>
                            <label for="email"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Correo
                                Electrónico</label>
                            <div class="relative">
                                <input id="email" type="email" v-model="formData.email" placeholder="Ingresa tu correo"
                                    required :disabled="isLoading"
                                    class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-dark-border text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-300">
                        ...
                        <div class="text-right">
                            <a href="#" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">¿Olvidaste tu
                                contraseña?</a>
                        </div>
                    ...
                    <div class="mt-6">
                        <button @click="loginWithMicrosoft" :disabled="isLoading"
