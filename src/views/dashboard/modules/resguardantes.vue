	...
	<div class="space-y-6">
		...
		<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-x-auto">
			<table class="w-full text-sm">
				...
				<tbody class="divide-y divide-gray-200 dark:divide-gray-600">
					<tr v-for="(resguardante, index) in resguardantes" :key="index"
						...
						<td class="px-4 py-3 flex gap-2">
							<button class="p-2 bg-green-600 hover:bg-blue-700 text-white rounded transition-colors">
							...
							<button @click="editResguardante(index)"
							...
							<button @click="deleteResguardante(index)"
			...
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-md w-full">
				...
				<div class="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
					<div>
						...
						<input v-model="newResguardanteData.nombre" type="text" placeholder="Nombre"
					...
					<div>
						...
						<input v-model="newResguardanteData.apellidos" type="text" placeholder="Apellido"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					</div>
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Correo
							Electrónico</label>
						<input v-model="newResguardanteData.correoElectronico" type="email"
					...
					<div>
						...
						<input v-model="newResguardanteData.password" type="password" placeholder="Contraseña"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					</div>
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Correo
							(Área)</label>
						<input v-model="newResguardanteData.correo" type="email" placeholder="Correo de área"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					</div>
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Rol</label>
						<select v-model="newResguardanteData.rol"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					...
					<div>
						...
						<select v-model="newResguardanteData.area"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
				...
				<div class="flex gap-2 justify-end border-t border-gray-300 dark:border-gray-600 p-6">
					...
					<button @click="saveNewResguardante"
						class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium">Guardar</button>
				</div>
			</div>
		</div>

		<!-- Edit Resguardante Modal -->
		<div v-if="showEditResguardanteModal"
			class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
				...
				<div class="p-6 space-y-4">
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nombre</label>
						<input v-model="editingResguardante.nombre" type="text" placeholder="Nombre"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					</div>
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Apellidos</label>
						<input v-model="editingResguardante.apellidos" type="text" placeholder="Apellido"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					</div>
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Correo
							Electrónico</label>
						<input v-model="editingResguardante.correoElectronico" type="email"
							placeholder="correo@institucion.com"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					</div>
					<div>
						<label
							class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Contraseña</label>
						<input v-model="editingResguardante.password" type="password" placeholder="Contraseña"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					</div>
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Correo
							(Área)</label>
						<input v-model="editingResguardante.correo" type="email" placeholder="Correo de área"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
					</div>
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Rol</label>
						<select v-model="editingResguardante.rol"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
							<option>Administrador</option>
							<option>Resguardante Senior</option>
							<option>Resguardante</option>
					...
					<div>
						<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Área</label>
						<select v-model="editingResguardante.area"
							class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
							<option>RR.HH</option>
							<option>Sistemas</option>
							<option>Administración</option>
				...
				<div class="flex gap-2 justify-end border-t border-gray-300 dark:border-gray-600 p-6">
					<button @click="showEditResguardanteModal = false"
						class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-white rounded-lg hover:bg-gray-400 dark:hover:bg-gray-500 transition-colors">Cancelar</button>
					<button @click="saveEditResguardante"
						class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium">Guardar</button>
				</div>
			</div>
		</div>
		...
		<div v-if="showDeleteConfirm"
			...
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-md w-full">
				...
				<div class="p-6">
					<p class="text-gray-600 dark:text-gray-400">¿Está seguro de que desea eliminar este resguardante?
					</p>
				</div>
				<div class="flex gap-2 justify-end border-t border-gray-300 dark:border-gray-600 p-6">
					<button @click="showDeleteConfirm = false"
					...
					<button @click="confirmDelete"
						class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors font-medium">Eliminar</button>
				</div>
			</div>
		</div>
	</div>
