<template>
	<div class="space-y-6">
		...
		<div class="bg-white dark:bg-dark-bg rounded-lg border border-gray-200 dark:border-gray-600 shadow-md dark:shadow-stone-950 p-6 space-y-3">
			<div class="flex items-center gap-3 mb-4">
				...
				<h3 class="text-lg font-bold text-gray-900 dark:text-white">Configuración de los bienes</h3>
			</div>

			<button 
				@click="showCategoriesModal = true"
				class="w-full px-4 py-3 text-left text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors flex items-center justify-between group"
			>
				<span class="flex items-center gap-2">
					<svg class="w-4 h-4 text-gray-500 dark:text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
