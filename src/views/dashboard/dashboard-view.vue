				...
				<div class="p-4 flex items-center justify-between">
					...
					<div class="relative">
						...
						<div
							...
							@click.outside="!isLoggingOut && (isProfileMenuOpen = false)"
						...
						>
							...
							>
								<span v-if="isLoggingOut" class="flex items-center justify-center">
									<div class="spinner-logout mr-2 animate-spin inline-block w-4 h-4 border-2 border-current border-r-transparent rounded-full"></div>
									Cerrando sesión...
								</span>
								<span v-else>
									Cerrar Sesión
